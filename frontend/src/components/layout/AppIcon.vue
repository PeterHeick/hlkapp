...
<template>
  <!-- Inline SVG ikoner — lucide-stil hairline -->
  <svg
    :width="size ?? 18"
    :height="size ?? 18"
    viewBox="0 0 24 24"
  ...
  >
    ...
    <!-- Stop -->
    <template v-else-if="name === 'StopSquare'">
    ...
    <!-- Alert triangle -->
    <template v-else-if="name === 'AlertTri'">
    ...
    <!-- Arrow down (deep) -->
    <template v-else-if="name === 'ArrowDown'">
